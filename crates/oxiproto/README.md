...
oxiproto = { version = "0.1.4", features = ["build"] }

# Runtime reflection + canonical JSON.
oxiproto = { version = "0.1.4", features = ["reflect", "json"] }

# Well-Known Types with chrono interop.
oxiproto = { version = "0.1.4", features = ["wkt-chrono"] }

# Everything.
oxiproto = { version = "0.1.4", features = ["build", "reflect", "wkt-chrono", "codegen", "json"] }
```
